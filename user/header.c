...
const __unit_header unit_header_t unit_header = {
    ...
    .dev_id = 0x6C63776B,                                   // Developer ID: 'lcwk'
    .unit_id = 0x01U,                                       // ID for this unit. Scoped within the context of a given dev_id.
    .version = 0x00000900U,                                 // This unit's version: major.minor.patch (major<<16 minor<<8 patch).
    .name = "LPF",                                          // Name for this unit, will be displayed on device
    ...
    .params = {
        ...
        {0, 1, 0, 0, k_unit_param_type_none, 0, 0, 0, {"TYPE"}},
